...
// アニメーションの各段階を管理するState
type AnimationPhase = 'clouds' | 'text' | 'logo' | 'end'

// onIntroEnd: イントロ終了時に呼ばれるコールバックを追加
interface IntroAnimationProps {
  onIntroEnd?: () => void
}

export const IntroAnimation: React.FC<IntroAnimationProps> = ({ onIntroEnd }) => {
