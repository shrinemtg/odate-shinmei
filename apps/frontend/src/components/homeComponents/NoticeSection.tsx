...
const noticeData = [
  {
    id: 1,
    title: '鎮座350年記念し例祭を斎行します。',
    date: '令和7年9月10日、11日',
    detail:
      'この度、当神社では鎮座350年を記念し、大祭を執り行います。9月10日は午後6時より宵宮祭を、9月11日は午前8時30分より例祭、午前10時より御神幸祭を斎行いたします。なお、宵宮祭・例祭の両日において、神楽舞（浦安の舞・悠久の舞）を奉納いたします。また、10日午後1時からは余興奉納奉告祭が行われ、13台の山車と4台の子供神輿が境内に集合し、祭りを賑やかに彩ります。皆様お誘い合わせの上、ご参拝ください。',
  },
  {
    id: 2,
    title: '七五三のご予約について',
